...
public class SimplePublishPortable {
    ...
    public void publish() {
        try {
            ...
            getAuthTokenMyPub.setUserID("pagul");                    //your username
            ...
            myServName.setValue("EmployeeService");
            myService.getName().add(myServName);

            BindingTemplate myBindingTemplate = new BindingTemplate();
            AccessPoint accessPoint = new AccessPoint();
            accessPoint.setUseType(AccessPointType.WSDL_DEPLOYMENT.toString());
            accessPoint.setValue("http://example.org/services/employeeservice?wsdl");
            ...
            System.out.println("employeeService key:  " + myServKey);

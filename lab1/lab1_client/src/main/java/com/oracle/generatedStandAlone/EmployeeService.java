 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://lab2_crud.oracle.com/", wsdlLocation = "http://localhost:8081/EmployeeWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://lab2_crud.oracle.com/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/EmployeeWebService?wsdl");
    ...
    public EmployeeWebService getEmployeeWebServicePort() {
        return super.getPort(new QName("http://lab2_crud.oracle.com/", "EmployeeWebServicePort"), EmployeeWebService.class);
    }
    ...
    public EmployeeWebService getEmployeeWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab2_crud.oracle.com/", "EmployeeWebServicePort"), EmployeeWebService.class, features);
    }

 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://lab1_j2ee.oracle.com/", wsdlLocation = "http://localhost:8080/lab1_j2ee-1.0-SNAPSHOT/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://lab1_j2ee.oracle.com/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab1_j2ee-1.0-SNAPSHOT/EmployeeService?wsdl");
    ...
    public EmployeeWebService getEmployeeWebServicePort() {
        return super.getPort(new QName("http://lab1_j2ee.oracle.com/", "EmployeeWebServicePort"), EmployeeWebService.class);
    }
    ...
    public EmployeeWebService getEmployeeWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1_j2ee.oracle.com/", "EmployeeWebServicePort"), EmployeeWebService.class, features);
    }
